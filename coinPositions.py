...
# coinPositionsDict = {"Y1":initiallization.pathY[0],"Y2":initiallization.pathY[0],"Y3":initiallization.pathY[0],"Y4":initiallization.pathY[0],
...
#                      "G1":initiallization.pathG[0],"G2":initiallization.pathG[0],"G3":initiallization.pathG[0],"G4":initiallization.pathG[0]} # Dictionary of other colors' coin positions
